...
$(function() {
	...
	function deleteAll(){
	    ...
	    if (isDel) {
	       //要删除
	       $("#mainForm").attr("action", "${pageContext.request.contextPath}/background/deleteAll.action");
	       $("#mainForm").submit();
	    }
	}
...
<body>
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="${ctx}/background/findAllCategory.action">显示全部商品</a></li>
                            <li><a href="${ctx}/background/getCategory.action">添加商品</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">分类管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${ctx}/backgroundCategory/getAddCategoryPage.action">添加分类</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">轮播图管理</span><span class="label label-warning pull-right">16/24</span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${ctx}/backgroundslideshow/findAllSlideShow.action">显示所有轮播图</a></li>
                            <li><a href="${ctx}/backgroundslideshow/getAddSlideShow.action">添加轮播图</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="${ctx}/getOrderBack/getUserOrder.action"><i class="fa fa-pie-chart"></i> <span class="nav-label">订单管理</span>  </a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">管理员管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">支付管理</span>  <span class="pull-right label label-primary">SPECIAL</span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="contacts.html">Contacts</a></li>
                            <li><a href="profile.html">Profile</a></li>
    ...
    <!-- Mainly scripts -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery-2.1.1.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.metisMenu.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.slimscroll.min.js"></script>

    <!-- Flot -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.flot.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.flot.tooltip.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.flot.spline.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.flot.resize.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.flot.pie.js"></script>

    <!-- Peity -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.peity.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/peity-demo.js"></script>

    <!-- Custom and plugin javascript -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/inspinia.js"></script>
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/pace.min.js"></script>

    <!-- jQuery UI -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/Chart.min.js"></script>

    <!-- Toastr -->
    <script src="${pageContext.request.contextPath}/resources/thirdlib/H+/js/toastr.min.js"></script>
