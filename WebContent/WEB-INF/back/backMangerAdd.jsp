...
<body>
				...
				<ul class="nav metismenu" id="side-menu">
					...
					<li class="active"><a href="index.html"><i
						...
						<ul class="nav nav-second-level">
							...
							<li class="active"><a href="${ctx}/background/getCategory.action">添加商品</a></li>
						</ul></li>
					...
					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
							<span class="nav-label">轮播图管理</span><span
					...
					<li><a href="${ctx}/getOrderBack/getUserOrder.action"><i class="fa fa-pie-chart"></i>
							<span class="nav-label">订单管理</span> </a></li>
					...
					<li><a href="#"><i class="fa fa-desktop"></i> <span
							class="nav-label">支付管理</span> <span
						...
						<li class="dropdown"><a class="dropdown-toggle count-info"
							...
							<ul class="dropdown-menu dropdown-messages">
								<li>
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle" src="${ctx}/resources/img/a7.jpg">
										</a>
								...
								<li>
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle" src="${ctx}/resources/img/a4.jpg">
										</a>
										<div class="media-body ">
								...
								<li>
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle" src="${ctx}/resources/img/profile.jpg">
										</a>
										<div class="media-body ">
	...
	<div class="small-chat-box fadeInRight animated">
		...
		<div class="content">
			...
			<div class="left">
				...
				<div class="chat-message active">I belive that. Lorem Ipsum is
	...
	<script
		src="${ctx}/resources/thirdlib/H+/js/jquery.flot.tooltip.min.js"></script>
