    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li  class="active">
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">轮播图管理</span><span class="fa arrow">16/24</span></a>
				...
				<table class="align-center table  table-bordered table-hover table-condensed">
					...
					<c:forEach items="${pageBean.list}" var="slideShow">
						<tr>
							...
							<td><img alt="" src="/pic/${slideShow.main_image}" width="192"
									height="44"></td>
